...
if (!SANITY_PROJECT_ID) {
    console.warn('⚠️  SANITY_PROJECT_ID is not set. Please create a .env file with your Sanity credentials.');
    console.warn('   See .env-sample for required variables.');
}

export const sanityConfig: ClientConfig = {
    projectId: SANITY_PROJECT_ID || 'placeholder-project-id',
...
export const client = SANITY_PROJECT_ID && SANITY_PROJECT_ID !== 'placeholder-project-id'
